 ...
 */
public final class AtSignHelper implements ClickableForegroundColorSpan.OnSpanClickListener {
    ...
    private OnAtSignClickListener mOnAtSignClickListener;
    ...
    public static final class Creator {
        ...
        public static AtSignHelper create(int color, OnAtSignClickListener listener) {
            return new AtSignHelper(color, listener, null);
        }

        public static AtSignHelper create(int color, OnAtSignClickListener listener, char... additionalHashTagChars) {
            return new AtSignHelper(color, listener, additionalHashTagChars);
        }

    }

    public interface OnAtSignClickListener {
        void onAtSignClicked(String atSign);
    }
    ...
    private AtSignHelper(int color, OnAtSignClickListener listener, char... additionalHashTagCharacters) {
        mHashTagWordColor = color;
        mOnAtSignClickListener = listener;
    ...
    public void handle(TextView textView) {
        if (mTextView == null) {
            ...
            if (mOnAtSignClickListener != null) {
    ...
    public List<String> getAllAtSigns(boolean withHashes) {
    ...
    public List<String> getAllAtSigns() {
        return getAllAtSigns(false);
    }

    @Override
    public void onSpanClicked(String hashTag) {
        mOnAtSignClickListener.onAtSignClicked(hashTag);
    }
}
